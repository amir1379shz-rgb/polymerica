...
export default function PolymerMarket() {
  ...
  useEffect(() => {
    const titles = {
      home: "پلیمر بازار | سامانه رسمی بازار پلیمر و پلاستیک",
      market: "بازار آگهی‌های خرید و فروش پلیمر | پلیمر بازار",
      post: "ثبت آگهی خرید یا فروش | پلیمر بازار",
      my: "آگهی‌های من | پلیمر بازار",
      pricing: "تعرفه اشتراک | پلیمر بازار",
      rules: "قوانین و مقررات | پلیمر بازار",
      about: "درباره سامانه | پلیمر بازار",
    };
    document.title = titles[tab] || "پلیمر بازار";
  }, [tab]);
      ...
      <header className="sticky top-0 z-30 pm-panel backdrop-blur border-b pm-line">
        <div className="max-w-6xl mx-auto px-4 md:px-6 flex items-center justify-between h-16">
          <button onClick={() => setTab("home")} className="flex items-center gap-2.5 shrink-0">
            ...
            <div className="font-extrabold text-lg tracking-tight pm-navy">پلیمر بازار</div>
          </button>
...
function Privacy() {
  return (
    <main className="max-w-3xl mx-auto px-4 md:px-6 py-10">
      ...
      <p className="pm-muted text-sm mb-6">سامانه پلیمر بازار متعهد به حفظ اطلاعات شخصی کاربران است.</p>
...
function About() {
  return (
    <main className="max-w-3xl mx-auto px-4 md:px-6 py-10">
      <h1 className="text-2xl font-bold mb-2">درباره پلیمر بازار</h1>
      ...
      <div className="pm-panel rounded-xl p-6 leading-8 text-sm flex flex-col gap-4">
        <p>
          پلیمر بازار با هدف تسهیل ارتباط مستقیم میان تولیدکنندگان، بازرگانان، واحدهای بازیافت و کارخانجات صنایع تکمیلی پلاستیک راه‌اندازی شده است.
        </p>
        <p>
